...
<body>
	<%
		List<Variete> varietes = (List<Variete>) request
				.getAttribute("varietes");
	%>
			...
			<table
				...
				<thead>
					<tr>
						...
						<th class="col-md-2 text-center bg-primary ">Modifier ?</th>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="glyphicon glyphicon-trash" data-toggle="modal"
								data-target="<%="#myModal" + i%>" id="remove"></div> <span
							id='variete' style="display: none"><%=variete.getLibelle()%></span>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											Voulez-vous supprimer la variété :
											<%=variete.getLibelle()%></div>
										<div class="modal-footer">
											<button type="button" class="btn btn-default"
												data-dismiss="modal">Non</button>
											<button type="button" id="button" class="btn btn-primary"
												onClick="location.href='?action=Supprimer&variete=<%=variete.getLibelle()%>'">Oui
											</button>
										</div>
									</div>
								</div>
